"""Stack-aware `doctor` for awscreen.
...
interesting failures live BETWEEN them. "awscreen is installed" is not the useful
fact -- "awscreen is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWSCREEN_MODEL', 'AWSCREEN_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awscreen needs at runtime, and a
